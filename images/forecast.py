...
try:
 page.goto("https://www.yr.no/en/forecast/daily-table/2-3099230/Poland/Silesian%20Voivodeship/Gliwice/Gliwice")
except:
 print("Unable to load 'https://www.yr.no/en/forecast/daily-table/2-3099230/Poland/Silesian%20Voivodeship/Gliwice/Gliwice'!!")
else:
 time.sleep(1)

 try:
  page.locator("#forecast-page__table").screenshot(path=f"forecast_temp.jpg")
 except:
  print("Unable to find weather plot!!")

try:
 page.goto("https://www.yr.no/en/forecast/graph/2-3099230/Poland/Silesian%20Voivodeship/Gliwice/Gliwice")
except:
 print("Unable to load 'https://www.yr.no/en/forecast/graph/2-3099230/Poland/Silesian%20Voivodeship/Gliwice/Gliwice'!!")
else:
 time.sleep(1)

 try:
  page.locator("#forecast-page__graph").screenshot(path=f"forecast_temp2.jpg")
 except:
  print("Unable to find weather plot!!")
